<?php
    include "../produtos/consultar-produto.php";
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <br>
            <div class="col-md-12">
                <a href="../produtos/formulario-produto.php" class="btn btn-outline-danger btn-sm">Adicionar</a>
                <hr>
            </div>
            <div class="col-md-12">  
                <?php
                    ...
                    <div class="table-responsive">
                        ...
                        <?php
                            foreach($lista_produtos as $product) {
                                ...
                                $link_editar = "../produtos/editar-produto.php?id=".$product['product_id'];
                                $link_excluir = "../produtos/excluir-produto.php?id=".$product['product_id'];
                        ...
                        ?>
                            <tr>
                                ...
                                <td  class="text-center col-2">
                                    ...
                                    <a class="btn btn-outline-info btn-sm" href=<?php echo $link_editar;?> role="button">Editar</a> 
                                    <a class="btn btn-outline-danger btn-sm" href=<?php echo $link_excluir;?> role="button">Excluir</a>
                                </td>
                            </tr>
